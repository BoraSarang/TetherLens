...
| 16 | DNS 표시 + 프리셋 변경 | P1 | Pending |

## Phase 2 — Advanced (4-6주)

| # | Task | Priority | Status |
|---|------|----------|--------|
| 17 | NEFilterDataProvider System Extension | P1 | Pending |
| 18 | 앱별 트래픽 리스트 | P1 | Pending |
| 19 | 스마트 절약 모드 | P1 | Pending |
| 20 | 통계 그래프 (Swift Charts) | P1 | Pending |
| 21 | 연결 이력 리포트 | P1 | Pending |
| 22 | 세션 시간 추적 | P2 | Pending |

## Phase 3 — Release (2-4주)

| # | Task | Priority | Status |
|---|------|----------|--------|
| 23 | Sparkle 자동 업데이트 | P0 | Pending |
| 24 | 코드 서명 + Notarization | P0 | Pending |
| 25 | GitHub Actions CI/CD | P0 | Pending |
| 26 | Buy Me a Coffee 도네이션 링크 | P1 | Pending |
| 27 | 로그인 시 시작 설정 | P1 | Pending |
