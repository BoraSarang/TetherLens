...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/Release-latest-0ea5e9">
</p>
...
| 기능 | 설명 |
|------|------|
| ❤️ **메뉴바 실시간 속도** | `▲ 120 KB/s / ▼ 1.2 MB/s` 업·다운 두 줄 표시. 인사이트 색(초록→빨강)으로 상태 직관 |
| 📱 **핫스팟 자동 감지** | iOS 개인용 핫스팟 ↔ Android 테더링 구분. SSID 기준 프로필 자동 전환 |
...
| 🛰️ **연결 품질 모니터링** | 8.8.8.8 + 게이트웨이 Ping RTT. 지속 위반 → 경고, 복구 자동 감지 |
...
| 🔌 **앱별 트래픽** | `nettop` 기반으로 어느 앱이 얼마나 쓰는지 실시간 순위 |
